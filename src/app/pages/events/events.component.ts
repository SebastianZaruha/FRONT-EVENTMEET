...
@Component({
  selector: 'app-events',
  imports: [CommonModule, RouterModule, NavbarComponent, CabeceraEventosComponent, UltimosComponent, CasillaEventoComponent, FooterComponent, BuscarMapaComponent],
